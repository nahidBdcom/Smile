...
@section('content')
    <div class="page-content container-fluid">
        <form class="form-edit-add" role="form" action="@if($edit){{ route('voyager.packages.update', $dataTypeContent->id) }}@else{{ route('voyager.packages.store') }}@endif" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="voyager-character"></i> {{ __('voyager::package.title') }}
                                <span class="panel-desc"> {{ __('voyager::package.title_sub') }}</span>
                            </h3>
