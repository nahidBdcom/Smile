...
class CommonController extends Controller
{
    ...
    public function packageUpdated($packageCategory){
        ...
        $faqs = package::join('package_faqs', 'package_faqs.package_id', 'packages.id')->where('packages.package_category_id', $packages->id)->orderBy('package_faqs.order')->get();
        // dd($faqs);
        return view('package_updated', compact('packages','socialMedias','faqs'));
